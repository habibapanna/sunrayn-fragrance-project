  ...
  return (
    ...
    >
      <div className="bg-[#EDE8E0] rounded-[32px] md:rounded-[48px] md:p-20 relative overflow-hidden cursor-pointer">
        ...
        {/* 🔹 DESKTOP (ANIMATED) */}
        {!isMobile && (
          <div className="hidden md:block absolute md:top-[400px] md:left-[50px] lg:left-[150px] lg:top-[300px] 2xl:top-[600px] 2xl:left-[400px] left-[150px] -translate-y-1/2 text-[#571313]">
