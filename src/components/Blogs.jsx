    ...
    <div className="mx-auto px-[16px] 2xl:px-[32px] pb-[16px] 2xl:pb-[32px]">
      ...
      <div className="hidden lg:flex justify-between mb-[16px] 2xl:mb-[32px]">
        <div className="flex items-center gap-[32px]">
          ...
          <Link
            to="/productList"
            className="bg-[#BA9948] text-white font-semibold px-[32px] py-[12px] rounded-full"
          >
            Read All
          </Link>
        </div>
        ...
        <div className="flex gap-5">
          <button className="blog-prev w-[55px] h-[55px] rounded-full bg-[#F5F1EA] flex items-center justify-center">
            <GoChevronLeft className="text-[35px]" />
          </button>
          <button className="blog-next w-[55px] h-[55px] rounded-full bg-[#F5F1EA] flex items-center justify-center">
        ...
        {blogs.map((item, idx) => (
          <SwiperSlide key={idx}>
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white text-[25px] md:text-[30px] 2xl:text-[40px] font-medium">
                {item.title}
              </div>
            </div>
          </SwiperSlide>
