  ...
  return (
    ...
    hover:bg-[#BA9948] border border-[#BA9948] text-[#1D0B01] font-semibold  2xl:px-[32px] 2xl:py-[12px] rounded-full cursor-pointer lg:w-[139px] lg:h-[50px] text-[14px] lg:text-[16px] 2xl:text-[20px] flex items-center justify-center"
      ...
      <div className="flex lg:hidden items-center justify-between pb-[16px]">
          ...
          <Link
            to="/blogs"
            className="hover:bg-[#BA9948] border border-[#BA9948] hover:border-none text-[#1D0B01] px-[24px] py-[8px] rounded-full text-[14px] cursor-pointer flex items-center w-[105px] h-[30px] transition-all duration-500
            "
          >
            Read All
          </Link>
