...
<div className="grid grid-cols-3 gap-4">
  ...
  <label className="flex items-center gap-2 text-[14px] 2xl:text-[16px] text-[#282828] mt-[4px] cursor-pointer">
    ...
    bg-[#BA9948] hover:text-[#1D0B01] hover:bg-white backdrop-blur-md border hover:border-[#A0174A] text-white py-[10px] px-[12px] rounded-full font-semibold text-[14px] 2xl:text-[16px] cursor-pointer">Continue to Payment</button>
