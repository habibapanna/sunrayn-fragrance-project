...
const HolidayOffer = () => {
    return (
        <div className='pt-[16px] 2xl:pt-[32px] '>
            <Offer></Offer>
            <section className='px-[16px] 2xl:px-[32px]'><SortFilter></SortFilter></section>
            {/* Cards */}
                        <section className="relative overflow-hidden pb-[16px] px-[16px] 2xl:px-[32px]">
                                   <div
            ...
            <section className='px-[16px] 2xl:px-[32px]'><Premium></Premium></section>
        </div>
    );
};
