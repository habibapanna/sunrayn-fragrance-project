  ...
  return (
    <div className="bg-white">
      ...
      <section className="mx-auto px-[16px]  2xl:px-[32px] pb-[16px] 2xl:pb-[32px]">
        <div className="bg-[#F6F7F2] rounded-[16px] grid grid-cols-1 md:grid-cols-2 gap-[16px] lg:gap-[48px] 2xl:gap-[189px] p-[16px] lg:p-[32px] items-center">
          <img
    ...
    bg-[#BA9948] hover:text-[#1D0B01] hover:bg-white backdrop-blur-md border hover:border-[#A0174A]  text-[20px] text-white  px-[20px] py-[8px] lg:px-[24px] lg:py-[10px] 2xl:h-[55px] 2xl:w-[210px]">
              Shop Now
            </button></Link>
          </div>
        </div>
