...
const navBgClass = isProductList || isContact || isFaq || isAbout || isTerms || isBlogPage || isBlogDetails || isProductDetails || isHolidayOffer
  ? "bg-[#BA9948]/45 backdrop-blur-2xl rounded-full mt-[10px]"
  : scrolled
  ? "bg-[#BA9948]/45 backdrop-blur-2xl rounded-full mt-[6px] 2xl:mt-[10px] mx-[16px] 2xl:mx-[32px]"
  : "bg-transparent";
...
/>
          ...
          <div className="flex items-center gap-[16px] 2xl:gap-[24px]">
            ...
            <div className="hidden lg:flex items-center gap-[12px] bg-white/90 text-[#282828] pr-[9px] pl-[24px] py-[12px] rounded-[100px] 2xl:mr-16 w-[563px] h-[50px]">
...
<button
          ...
          className="flex items-center gap-[5px] text-[15px] cursor-pointer uppercase"
        >
          Perfumes
          <LiaAngleDownSolid
...
<Link to='/about'><button className="cursor-pointer text-[15px] uppercase">About Us</button></Link>


             <Link to='holidayOffer'> <span className="bg-[#FD4929] text-white text-[15px] px-[20px] py-[8px] rounded-[100px] font-semibold flex items-center gap-[6px] w-[170px] h-[35px] uppercase">
