...
<Link to='/about'><button className="cursor-pointer text-[16px]">About Us</button></Link>
             ...
             <Link to='holidayOffer'> <span className="bg-[#571313] text-white text-[16px] px-[12px] py-[7px] rounded-[100px] font-semibold flex items-center gap-[6px] w-[139px] h-[34px]">
...
<div className="border border-[#571313]/10"></div>
  ...
  <button className="bg-[#571313] text-white text-[16px] px-[12px] py-[14px] rounded-[100px] font-semibold flex items-center gap-[6px] w-full justify-center">
