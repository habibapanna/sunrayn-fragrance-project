...
<button
  ...
  {openMegaMenu === "perfume" && (
          ...
          >
         <div className="fixed top-[60px] right-[250px] lg:top-[90px] lg:right-[350px] 2xl:right-[850px] z-50">
...
<div
  ...
  {/* COLLECTION MEGA MENU */}
   {openMegaMenu === "collection" && (
          ...
          >
        {/* MEGA MENU */}
    <div className="fixed top-[60px] right-[150px] lg:top-[90px] lg:right-[230px] 2xl:right-[700px] z-50">
...
<div className="relative">
  <button
    ...
    className="
      lg:p-[10px] p-[8px] md:h-[30px] md:w-[30px] 
      lg:h-[40px] lg:w-[40px] 2xl:p-[15px] 
      rounded-full 2xl:h-[50px] 2xl:w-[50px]
      bg-white/90 flex items-center justify-center cursor-pointer
    "
  >
